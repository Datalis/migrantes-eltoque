	...
	<div class="container">
		<div class="flex flex-col justify-center items-center pt-10 md:pt-32">
			<div class="max-w-3xl md:mb-10 px-10">
				...
				<p class="text-light">
					Hasta el momento hemos identificado {events.length} incidentes que han ocurrido desde enero de 2021 que 
					involucran a migrantes cubanos en diferentes zonas geográficas. Los eventos dramáticos que involucran a 
					migrantes incluyen una serie de hechos como deportaciones, rescates, intercepciones en el mar, detenidos 
					por las autoridades de los países donde se encuentra, devueltos o repatriados. En estos casos, si bien no 
					siempre terminan con la vida de las personas, frustran sus planes y las ponen en una situación de vulnerabilidad.
					Algunas de ellas invirtieron todos sus ahorros, vendieron sus pertenencias o renunciaron a sus trabajos y no 
					tienen otras alternativas legales para migrar.
				</p>

				<p class="text-light mt-2">
					Por ejemplo, desde octubre de 2020 hasta enero de 2023, la Guardia Costera de los Estados Unidos 
					<a
						...
						rel="noreferrer"
					>interceptó</a>
					a 11 937 migrantes cubanos en el mar cuando intentaban llegar a territorio estadounidense. La mayoría de ellos 
					fueron repatriados a la isla. Según los datos recopilados por nuestro equipo durante ese período, las autoridades
					nacionales regresaron a Cuba al menos a 8 643 personas desde Estados Unidos, 5 902 desde México, 16 desde 
					Guatemala y 195 desde Bahamas.
				</p>

				<p class="text-light mt-2">
					En esta línea de tiempo se pueden consultar todos los eventos que hemos identificado y que involucran a cubanos.
				</p>
			</div>
		</div>
		<div
