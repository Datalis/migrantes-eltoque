<script lang="ts">
  ...
  import { fade } from 'svelte/transition';
	...
	import ArrowDown from '$lib/assets/images/arrow-down.svg?component'
...
>
  ...
  <div class="w-96 text-center flex flex-col items-center">
    ...
    Cada círculo corresponde a un evento migratorio. Puedes seguir explorando cada uno de ellos en esta herramienta interactiva y seleccionar las categorías que quieras ver.
		<div class="w-14 h-14 rounded-full border-accent border-2 p-2 flex items-center mt-4 cursor-pointer">
			<ArrowDown />
		</div>
  </div>
</div>
