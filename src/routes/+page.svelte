<script lang="ts">
	...
	const { totals, deceased, missing, articles, places, events, modal } = data;
...
<main class="overflow-hidden">
	...
	<Section_4 {deceased} showModal={modal == 'fallecidos'} />
	<Section_5 {missing} {totals} showModal={modal == 'desaparecidos'} />
	<Section_6 {places} />
